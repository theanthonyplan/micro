...
class MicroDatabaseRouter(object):
    """
    ...
    def allow_relation(self, obj1, obj2, **hints):
        ...
        if obj1._meta.app_label in APP_LABEL and obj2._meta.app_label in APP_LABEL:
            return True
        # No opinion if neither object is in the Example app (defer to default or other routers).
        elif APP_LABEL not in [obj1._meta.app_label, obj2._meta.app_label]:
            return None
